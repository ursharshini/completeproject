...
var teamData = [

    {
        ...
        "teamIcon": "https://media.nojoto.com/content/media/15385/2019/05/feed/942240976ce6c69128390bcc96bda5bc/942240976ce6c69128390bcc96bda5bc_default.jpg",
        "captain": "Sachin",
    },
    {
        "id": 1,
...
let s = [
        "https://assets.iplt20.com/bcci/articles/1655276240__RAJ0314%20%281%29.jpg","https://www.insidesport.in/wp-content/uploads/2019/09/IPL-1.jpg",
         "https://www.insidesport.in/wp-content/uploads/2020/08/1-42.jpg",
        "https://qph.cf2.quoracdn.net/main-qimg-1aac48fd7c7d6c55d0d70bad75962c30-lq",
        "https://www.firstpost.com/wp-content/uploads/2021/10/CSK-Trophy-640-Sportzpics.jpg"]
        let autod = $(".auto_display")
        var autod1 = $("<div>")
        console.log(autod1,autod)
        ...
        function wishd() 
        {
                ...
                setTimeout(wishd, 1000)
        }
    });
var y=document.querySelector('#add-team-button')
y.addEventListener('click',addteamclicked)
var r=document.querySelector('#add-player-button')
r.addEventListener('click',addPlayerClicked)
